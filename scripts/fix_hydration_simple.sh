...
# Деплой исправлений для гидратации React (простой вариант)
...
spawn scp "/Users/conspiratus/Projects/Este_Nomada/app/[locale]/layout.tsx" $server:/tmp/locale_layout.tsx
expect {
    "password:" {
        send "$password\r"
        exp_continue
