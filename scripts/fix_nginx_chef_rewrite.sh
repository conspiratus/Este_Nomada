...
# Исправление rewrite в nginx для /chef/
...
send "sudo sed -i '/location \\/ {/r /tmp/chef_location_fixed.conf' /etc/nginx/sites-available/estenomada\r"
expect "administrator@*"
