...
# Деплой исправления гидратации (удаление app/page.tsx)
...
puts "=========================================="
puts "Деплой исправления гидратации"
puts "=========================================="
...
# Удаляем app/page.tsx если существует
puts "\n🗑️  Удаление app/page.tsx..."
send "sudo rm -f app/page.tsx\r"
expect "administrator@*"
