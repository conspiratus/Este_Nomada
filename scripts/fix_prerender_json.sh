...
# Исправление prerender-manifest.json с правильным JSON
...
# Создаём правильный prerender-manifest.json
puts "\n📝 Создание правильного prerender-manifest.json..."
send "sudo bash -c 'cat > .next/prerender-manifest.json << \"EOF\"\r"
expect ">"
send "{\r"
expect ">"
send "  \"version\": 4,\r"
